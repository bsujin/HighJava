...
//		stdTest.setRank(stdList)
		...
		ArrayList<Students> gradeCard = new ArrayList<>();
		gradeCard.add(new Students(1, "가가가"	, 50, 20, 30));
		gradeCard.add(new Students(3, "나나나", 20, 40, 23));
		gradeCard.add(new Students(8, "다다다", 30, 30, 33));
		gradeCard.add(new Students(7, "라라라", 40, 50, 40));
		gradeCard.add(new Students(5, "마마마", 60, 60, 30));
		gradeCard.add(new Students(6, "바바바", 60, 70, 20));
		gradeCard.add(new Students(2, "사사사", 70, 80, 40));
		gradeCard.add(new Students(9, "아아아", 80, 90, 50));
		gradeCard.add(new Students(10, "자자자", 90, 70, 70));
		gradeCard.add(new Students(4, "차차차", 100, 85, 40));

		System.out.println("-------처음 데이터-------- ");
		for (Students st : gradeCard) {
		...
		// 리스트에 넣은 데이터를 외부정렬
		System.out.println();
		Collections.sort(gradeCard, new Sort());
...
class Students implements Comparable<Students> {
	...
	public Students(int studentID, String name, int korean, int english, int math) {
		super();
...
class Sort implements Comparator<Students> {
	@Override
...
class rank implements Comparator<Students>{
